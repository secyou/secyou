...
import com.busicomjp.sapp.service.b.B5Service;
...
@Component
public class B5Controller extends BaseController implements Initializable {

	private Logger logger = LoggerFactory.getLogger(B5Controller.class);
	@FXML
	private TableView<TorihikisakiSummaryData> payableDataTable;
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		torihikisakiAndDate.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.20));
		carryForwardAmountMoney.prefWidthProperty()
				.bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.08));
		depPay1.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request1.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance1.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay2.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request2.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance2.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay3.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request3.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance3.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay4.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request4.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance4.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay5.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request5.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance5.prefWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));

		torihikisakiAndDate.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.20));
		carryForwardAmountMoney.maxWidthProperty()
				.bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.08));
		depPay1.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request1.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance1.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay2.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request2.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance2.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay3.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request3.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance3.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay4.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request4.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance4.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay5.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request5.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance5.maxWidthProperty().bind(payableDataTable.widthProperty().subtract(10.0).multiply(0.048));
	}
            ...
            protected Task<String> createTask() {
                Task<String> task = new Task<String>() {
                    ...
                    protected String call() throws Exception {
                		...
                		b5Service.generatePdfReport(companyCode);
                        return "OK";
                    }
                };
	...
	private void onPrevData() {
		...
		if (currentDate != null) {
			Date startDate = b5Service.getKiStartDate();
			if (b5Service.compareYearMonthDate(currentDate, startDate) != 0) {
				currentDate = b5Service.getYearMonth(currentDate, -1);
				String startYearMonth = dateFormat.format(currentDate);
				String endYearMonth = dateFormat.format(b5Service.getYearMonth(currentDate, 4));
				String companyCode = CompanyUtil.getCompanyCode();

				// 検索
				List<TorihikisakiSummaryData> dataList = b5Service.selectAccountsSummary(companyCode,
				...
				payableDataTable.getItems().clear();
				payableDataTable.getItems().addAll(observableList);
	...
	private void onNextData() {
		logger.info(">");
		if (currentDate == null) {
			currentDate = b5Service.getKiStartDate();
		}

		Date date = b5Service.getYearMonth(currentDate, 4);
		Date kiEndMonth = b5Service.getKiEndMonth();
		Date endDate = null;
		if (b5Service.compareYearMonthDate(date, kiEndMonth) < 0) {
			currentDate = b5Service.getYearMonth(currentDate, 1);
			String startYearMonth = dateFormat.format(currentDate);
			endDate = b5Service.getYearMonth(currentDate, 4);
		...
		if (b5Service.compareYearMonthDate(endDate, kiEndMonth) == 0) {
			firstDataBtn.setDisable(false);
			prevDataBtn.setDisable(false);
	...
	private void onLastData() {
		logger.info(">>");
		Date kiEndMonth = b5Service.getKiEndMonth();
		currentDate = b5Service.getYearMonth(kiEndMonth, -4);
		...
		// 検索
		List<TorihikisakiSummaryData> dataList = b5Service.selectAccountsSummary(companyCode, startYearMonth,
				endYearMonth, false);
		final ObservableList<TorihikisakiSummaryData> observableList = FXCollections.observableArrayList(dataList);
		payableDataTable.getItems().clear();
		payableDataTable.getItems().addAll(observableList);
	...
	private void displayYearMonth(String startYearMonth, String endYearMonth) {
		List<String> yearMonthList = b5Service.getDisplayYearMonthList(startYearMonth, endYearMonth);
