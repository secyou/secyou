...
import com.busicomjp.sapp.service.b.B4Service;
...
@Component
public class B4Controller extends BaseController implements Initializable {

	private Logger logger = LoggerFactory.getLogger(B4Controller.class);
	
	@FXML
	private TableView<TorihikisakiSummaryData> receivableDataTable;
	@FXML
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		torihikisakiAndDate.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.20));
		carryForwardAmountMoney.prefWidthProperty()
				.bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.08));
		depPay1.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request1.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance1.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay2.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request2.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance2.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay3.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request3.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance3.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay4.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request4.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance4.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay5.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request5.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance5.prefWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));

		torihikisakiAndDate.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.20));
		carryForwardAmountMoney.maxWidthProperty()
				.bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.08));
		depPay1.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request1.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance1.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay2.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request2.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance2.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay3.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request3.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance3.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay4.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request4.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance4.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		depPay5.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		request5.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
		balance5.maxWidthProperty().bind(receivableDataTable.widthProperty().subtract(10.0).multiply(0.048));
	}
            ...
            protected Task<String> createTask() {
            	Task<String> task = new Task<String>() {
                    ...
                    protected String call() throws Exception {
                		...
                		b4Service.generatePdfReport(companyCode);
                        return "OK";
                    }
                };
	...
	private void onPrevData() {
		...
		if (currentDate != null) {
			Date startDate = b4Service.getKiStartDate();
			if (b4Service.compareYearMonthDate(currentDate, startDate) != 0) {
				currentDate = b4Service.getYearMonth(currentDate, -1);
				String startYearMonth = dateFormat.format(currentDate);
				String endYearMonth = dateFormat.format(b4Service.getYearMonth(currentDate, 4));
				String companyCode = CompanyUtil.getCompanyCode();

				// 検索
				List<TorihikisakiSummaryData> dataList = b4Service.selectAccountsSummary(companyCode,
				...
				receivableDataTable.getItems().clear();
				receivableDataTable.getItems().addAll(observableList);
	...
	private void onNextData() {
		logger.info(">");
		if (currentDate == null) {
			currentDate = b4Service.getKiStartDate();
		}

		Date date = b4Service.getYearMonth(currentDate, 4);
		Date kiEndMonth = b4Service.getKiEndMonth();
		Date endDate = null;
		if (b4Service.compareYearMonthDate(date, kiEndMonth) < 0) {
			currentDate = b4Service.getYearMonth(currentDate, 1);
			String startYearMonth = dateFormat.format(currentDate);
			endDate = b4Service.getYearMonth(currentDate, 4);
		...
		if (b4Service.compareYearMonthDate(endDate, kiEndMonth) == 0) {
			firstDataBtn.setDisable(false);
			prevDataBtn.setDisable(false);
	...
	private void onLastData() {
		logger.info(">>");
		Date kiEndMonth = b4Service.getKiEndMonth();
		currentDate = b4Service.getYearMonth(kiEndMonth, -4);
		...
		// 検索
		List<TorihikisakiSummaryData> dataList = b4Service.selectAccountsSummary(companyCode, startYearMonth,
				endYearMonth, false);
		final ObservableList<TorihikisakiSummaryData> observableList = FXCollections.observableArrayList(dataList);
		receivableDataTable.getItems().clear();
		receivableDataTable.getItems().addAll(observableList);
	...
	private void displayYearMonth(String startYearMonth, String endYearMonth) {
		List<String> yearMonthList = b4Service.getDisplayYearMonthList(startYearMonth, endYearMonth);
